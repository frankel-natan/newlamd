<%@ Page Title="" Language="C#" MasterPageFile="~/Student/StudentMaster.Master" AutoEventWireup="true" CodeBehind="payToTeacher.aspx.cs" Inherits="LamedNetLite.payToTeacher" %>
...
-->
    <div class="checkout" dir="rtl">
        ...
        <form class="form" autocomplete="off" novalidate>
            ...
            <fieldset>
                <label for="card-holder">שם בעל כרטיס</label>
                <input type="text" id="card-holder" />
            </fieldset>
            <fieldset class="fieldset-expiration">
                <label for="card-expiration-month">תוקף כרטיס</label>
                <div class="select">
            ...
            <button class="btn"><i class="fa fa-lock"></i>תשלום</button>
        </form>
    </div>
...
<asp:Content ID="Content6" ContentPlaceHolderID="scripts" runat="server">
    <script>$(".input-cart-number").on("keyup change", function () {
        ...
        document.getElementById("nametitel").innerHTML = "דף תשלום למורה";
