<%@ Page Title="" Language="C#" MasterPageFile="~/Student/StudentMaster.Master" AutoEventWireup="true" CodeBehind="StudentInformation.aspx.cs" Inherits="LamedNetLite.StudentInformation" %>
                ...
                <div class="col-md-8">
                    <div class="card mb-3">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-3">
                                    <h4 class="mb-0">מספר שיעורים שבוצעו</h4>
                                </div>
                                <div class="col-sm-9 text-secondary" >
                                <h4 class="mb-0" id="NumOfLessons"  runat="server">13</h4>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-3">
                                    <h5 class="mb-0">סכום ששולם</h5>
                                </div>
                                <div class="col-sm-9 text-secondary">
                                     <h5 class="mb-0" id="AmountPaid" runat="server">400₪</h5>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-3">
                                    <h5 class="mb-0">חוב</h5>
                                </div>
                                <div class="col-sm-9 text-secondary">
                                     <h5 class="mb-0" id="debt" runat="server">100₪</h5>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-3">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                ...
                                <div class="mt-3">
                                    <h4 runat="server" id="StudentName">נתן פרנקל</h4>
                                    <p class="text-secondary mb-1" runat="server" id="TeacherName">שם מורה-שלמה ילין</p>
                                    <p class="text-secondary mb-1" runat="server" id="SchoolName"> בית ספר רעים</p>
                                    <p class="text-muted font-size-sm" runat="server" id="LicenseType">סוג רישיון - אוטמט</p>
