<%@ Page Title="" Language="C#" MasterPageFile="~/Teacher/TeacherMaster.Master" AutoEventWireup="true" CodeBehind="payTeacherToAdmin.aspx.cs" Inherits="LamedNetLite.payTeacherToAdmin" %>
...
<div class="container">
  <div class="col1">
    <div class="card">
      <div class="front">
        ...
        <div class="date"><span class="date_value"style="direction: ltr;">MM / YYYY</span></div>
        <span class="fullname">שם מלא</span>
      </div>
      <div class="back">
  ...
  <div class="col2">
    ...
    <label>תוקף</label>
    <input class="expire" style="direction: ltr;" type="text" placeholder="MM / YYYY"/>
    ...
    <button class="buy"><i class="material-icons"></i> תשלום</button>
  </div>
</div>
</asp:Content>
